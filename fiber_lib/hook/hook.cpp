...
namespace sylar{
    // if this thread is using hooked func
...
// universal template for read and write func
...
#undef XX
    ...
    unsigned int sleep(unsigned int seconds){
        ...
        sylar::IOManager* iom = sylar::IOManager::GetThis();
        // add a tomer tp reschedule this fiber
